...
// Global access to the enums.
public enum PlayerType { PointGuard, ShootingGuard, SmallForward, PowerForward, Center }
public enum PlayerRace { Human, Orc }
...
public class GameManager : MonoBehaviour {
    ...
    private float[,] arcFormula = new float[4,5];
    ...
    public GameObject shootQuestion;
    ...
    public TextMeshProUGUI shootChance;
    public TextMeshProUGUI shootVelocity;
    public TextMeshProUGUI shootAcceleration;
    public TextMeshProUGUI shootArea;
    #endregion
    ...
    private void SeeShoot(int playerX, int playerY)
    {
        ...
        if (selectedPlayer.Race == PlayerRace.Human)
        {
            ...
            goalHuman.transform.position = new Vector3(endShootPositionOrc.x + 10, endShootPositionOrc.y, endShootPositionOrc.z);
    ...
    void KnockBack()
    {
        ...
        {
            //Push back left 
            if(gridPlayer[selectedPlayer.Poss.x - 1, selectedPlayer.Poss.y] != null)
            {
                KnockOut();
                return;
            }
        ...
        {
            //Push Up left
            if (gridPlayer[selectedPlayer.Poss.x - 1, selectedPlayer.Poss.y + 1] != null)
            {
                KnockOut();
                return;
            }
        ...
        {
            //Push Up
            if (gridPlayer[selectedPlayer.Poss.x, selectedPlayer.Poss.y + 1] != null)
            {
                KnockOut();
                return;
            }
